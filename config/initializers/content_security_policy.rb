...
Rails.application.configure do
  config.content_security_policy do |policy|
    ...
    policy.img_src     :self, 'https://*.googleapis.com', 'https://*.gstatic.com', '*.google.com', '*.googleusercontent.com',
                      'https://tabitsunagi-development.s3.ap-northeast-1.amazonaws.com', 'https://tabitsunagi-production.s3.ap-northeast-1.amazonaws.com', 'data:'
